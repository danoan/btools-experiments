...
int main(int argc, char* argv[])
{
    ...
    FlowControl::ODRConfigInput odrConfigInput(DCFReader::InputData::ODRConfigInput::ApplicationCenter::AC_LINEL,
                                               DCFReader::InputData::ODRConfigInput::CountingMode::CM_PIXEL,
                                               DCFReader::InputData::ODRConfigInput::SpaceMode::Linel,
                                               id.radius,
                                               id.gridStep,
                                               id.levels,
                                               id.ld,
